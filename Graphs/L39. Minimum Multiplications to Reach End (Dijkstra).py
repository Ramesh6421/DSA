# pronlrm link(https://practice.geeksforgeeks.org/problems/minimum-multiplications-to-reach-end/1?utm_source=youtube&utm_medium=collab_striver_ytdescription&utm_campaign=minimum-multiplications-to-reach-end)
'''
...
# Complexity
'''
TC-> 100000*N (N is length of array )  # it is not take entire complexity, it depends on input.
SC-> 100000
'''
